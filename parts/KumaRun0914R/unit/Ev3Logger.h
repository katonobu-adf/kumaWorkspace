...
#define HEADER "time(msec),Color(Reflect),Gyro(deg/sec),UltraSonic(cm),Touch,Tail,LeftWheel,RightWheel,Battery(mV),state,forward,turn\r\n"
...
public:
    ...
    void logging(int state, int forward, int turn);
