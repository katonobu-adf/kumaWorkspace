...
#define HEADER "time(msec),Color(Reflect),Gyro(deg/sec),UltraSonic(cm),Touch,Tail,LeftWheel,RightWheel,Battery(mV),state,forward,turn,range,shock\r\n"
...
public:
    ...
    void logging(int state, int forward, int turn, int range, int shock);
